(function ($) {
  ...
  /*---------------------
    countdown
    --------------------- */
  $("#getting-started").countdown("2018/12/12", function (event) {
    $(this).text(event.strftime("%D days %H:%M:%S"));
  });

  $("#getting-started-two").countdown("2018/12/06", function (event) {
    $(this).text(event.strftime("%D days %H:%M:%S"));
  });

  $("#getting-started-three").countdown("2018/11/06", function (event) {
    $(this).text(event.strftime("%D days %H:%M:%S"));
  });

  $("#getting-started-four").countdown("2018/08/06", function (event) {
    $(this).text(event.strftime("%D days %H:%M:%S"));
  });
  //Multistep form
